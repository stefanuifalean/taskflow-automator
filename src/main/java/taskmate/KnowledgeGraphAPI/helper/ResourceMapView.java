...
public class ResourceMapView {
  /**
   * When working with query results in the form of SPO triples we work with S, P, O of String type.
   * O can be either IRI or (Literal) Value, but IRIs are still represented as String.
   */
